...
console.log(character.raidBossesKilledThisWeek)
</script>
<div>
    <Tabs.Root bind:value={activeTab} class="w-full">
        ...
        <Tabs.Content value="raid" class="p-4 bg-gray-50 dark:bg-gray-800 rounded-md">
            <p class="text-2xl">Manaforge: Omega Progress - {character.raiderIOCharacterData.raid_progression.manaforge_omega.summary}</p>
